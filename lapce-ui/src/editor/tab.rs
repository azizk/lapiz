...
impl LapceEditorTab {
    ...
    pub fn remove_child(
        ...
        let editor_tab = Arc::make_mut(data
            .main_split
            .editor_tabs
                    ...
                    if content_rect.contains(mouse_event.pos) {
                        ...
                        match direction {
                            Some(direction) => {
                                ...
                                Arc::make_mut(&mut new_editor_tab).focus_active_tab(ctx);
                            }
                            None => {
            ...
            Event::Command(cmd) if cmd.is(LAPCE_UI_COMMAND) => {
                ...
                match command {
                    ...
                    LapceUICommand::NextEditorTab => {
                        ...
                        .focus_next_tab(ctx, &data.config.editor);
                    }
                    LapceUICommand::PreviousEditorTab => {
                        ...
                        .focus_previous_tab(ctx, &data.config.editor);
                    }
                    _ => (),
                }
            }
